...
const __k = 1e-5
const n = 0
const __NUM_X_CELLS = 500 * 2^n
const __NUM_Y_CELLS = 100 * 2^n
const __X_DOMAIN = 5.0 * 2^n
const __Y_DOMAIN = 1.0 * 2^n
const __NUM_TIMESTEPS = 100 #floor(Int, __NUM_CELLS/5)
